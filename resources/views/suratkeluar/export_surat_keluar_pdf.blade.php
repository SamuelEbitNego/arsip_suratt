          ...
          <table class="table table-bordered table-hover mt-2">
               <thead>
                    <tr>
                         ...
                         <th rowspan="2" class="align-middle text-center">No. Filling Cabinet</th>
                         <th colspan="2" class="text-center">Lokasi Simpan</th>
                         <th colspan="4" class="text-center">Keterangan (SKKAD)</th>
                         ...
                         <th rowspan="2" class="align-middle text-center">Tanggal Retensi</th>
                    ...
                    <tr>
                         ...
                         <th class="text-center">Terbatas</th>
                         <th class="text-center">Rahasia</th>
                         <th class="text-center">Sangat Rahasia</th>
                    </tr>
               </thead>
               <tbody>
